...
const regions = [
  {
    name: 'Europe',
    countries: ['Denmark', 'Germany', 'France', 'UK', 'Sweden', 'Norway', 'Finland', 'Netherlands', 'Belgium', 'Spain', 'Italy', 'Poland', 'Switzerland', 'Austria'],
    currencies: ['EUR', 'GBP', 'DKK', 'NOK', 'SEK', 'CHF', 'PLN'],
    systems: ['SEPA', 'SWIFT', 'Local ACH', 'Real-Time Payments'],
  },
  {
    name: 'Asia',
    countries: ['India', 'China', 'Japan', 'South Korea', 'Singapore', 'Thailand', 'Malaysia', 'Indonesia', 'Philippines', 'Vietnam', 'Bangladesh'],
